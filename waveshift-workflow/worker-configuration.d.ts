/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 140aea0de307cda78b2a65cd57c37cc0)
...
declare namespace Cloudflare {
	interface Env {
		...
		R2_PUBLIC_DOMAIN: "r2.waveshift.net";
		WORKFLOW_CALLBACK_SECRET: "waveshift-callback-secret-2025";
		SEPARATE_STORAGE: R2Bucket;
		DB: D1Database;
		FFMPEG_SERVICE: Service /* entrypoint FFmpegWorker from ffmpeg-worker */;
		TRANSCRIBE_SERVICE: Fetcher /* transcribe-worker */;
		FRONTEND_SERVICE: Fetcher /* waveshift-frontend */;
		SEP_TRANS_PROCESSOR: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PUBLIC_DOMAIN" | "WORKFLOW_CALLBACK_SECRET">> {}
}
